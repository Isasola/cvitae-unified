...
assert(consent.includes('preferences.analytics') && consent.includes('VITE_GA_MEASUREMENT_ID'), 'Analytics debe depender de la preferencia guardada')
...
console.log('Consentimiento y publicidad: 26 verificaciones focalizadas superadas.')
