"""Agroindustria / Commodities paraguayos — portales de RRHH."""
import requests
...
EMPRESAS = [
    ("cargill_py",       "https://www.cargill.com.py/trabaja-con-nosotros",                            "Cargill Paraguay"),
    ("bunge_py",         "https://careers.bunge.com/search/?q=paraguay&locationsearch=paraguay",        "Bunge Paraguay"),
    ("louis_dreyfus_py", "https://careers.ldcom.com/search/?q=paraguay",                               "Louis Dreyfus Paraguay"),
    ("adm_py",           "https://careers.adm.com/search/?q=paraguay",                                 "ADM Paraguay"),
    ("cofco_py",         "https://www.cofco-international.com/en/careers/",                             "COFCO International Paraguay"),
    ("lactolanda",       "https://www.lactolanda.com.py/trabaja-con-nosotros",                          "Lactolanda Paraguay"),
    ("molinos_tacuare",  "https://www.molinostacuare.com.py/trabaja-con-nosotros",                     "Molinos Tacuaré"),
    ("grupo_favero",     "https://www.favero.com.py/trabaja-con-nosotros",                              "Grupo Favero"),
    ("agrofertil",       "https://www.agrofertil.com.py/trabaja-con-nosotros",                         "Agrofértil"),
    ("aca_py",           "https://www.aca.coop/trabaja-con-nosotros",                                   "ACA Paraguay"),
]

SOURCE = "agroindustria_py"
RUBRO  = "Agroindustria / Commodities"
