...
def fetch_detail(url):
    ...
    if not description:
        for sel in [
            "div#offerDec", "div.offerDesc", "div[data-qa='job-description']",
            "section.boxDescription", "div.js-description", "div[class*='description']",
        ]:
...
def main():
    ...
    print(
        f"\n=== Computrabajo PE: {summary.inserted} nuevas, {summary.updated} actualizadas, "
