"""Farmacias y laboratorios farmacéuticos de Paraguay — portales de RRHH."""
import requests
...
EMPRESAS = [
    ("farmacenter", "https://www.farmacenter.com.py/trabaja-con-nosotros", "Farmacenter"),
    ("catedral", "https://www.farmaciascatedral.com.py/trabaja-con-nosotros", "Farmacias Catedral"),
    ("astro", "https://www.farmaciasastro.com.py/trabaja-con-nosotros", "Farmacias Astro"),
    ("sanroque", "https://www.farmaciassanroque.com.py/trabaja-con-nosotros", "Farmacias San Roque"),
    ("farmacoop", "https://www.farmacoop.com.py/trabaja-con-nosotros", "Farmacoop"),
    ("medicity", "https://www.medicity.com.py/trabaja-con-nosotros", "Medicity"),
    ("puntofarma", "https://www.puntofarma.com.py/trabaja-con-nosotros", "Punto Farma"),
    ("indufar", "https://www.indufar.com.py/trabaja-con-nosotros", "Indufar"),
    ("lasca", "https://www.lasca.com.py/trabaja-con-nosotros", "Laboratorios Lasca"),
]

RUBRO = "Salud / Farmacia"
SOURCE = "farmacias_py"
...
def main():
    ...
    for job in all_jobs:
        ...
        if status in (200, 201, 409):
            count += 1
    print(f"[farmacias] Total insertados: {count}/{len(all_jobs)}")
