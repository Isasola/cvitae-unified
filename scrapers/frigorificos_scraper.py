"""Frigoríficos / Industria Cárnica paraguaya — portales de RRHH."""
import requests
...
EMPRESAS = [
    ("copacar",         "https://www.copacar.com.py/trabaja-con-nosotros",           "COPACAR"),
    ("frigo_concepcion","https://www.frigoconcepcion.com.py/trabaja-con-nosotros",   "Frigorífico Concepción"),
    ("frigo_guarani",   "https://www.frigorificoguarani.com.py/trabaja-con-nosotros","Frigorífico Guaraní"),
    ("frigolar",        "https://www.frigolar.com.py/trabaja-con-nosotros",          "Frigolar Paraguay"),
    ("frigomerc",       "https://www.frigomerc.com.py/trabaja-con-nosotros",         "Frigomerc (Grupo Carteshs)"),
    ("frigo_py",        "https://www.frigorifico.com.py/trabaja-con-nosotros",       "Frigorífico Paraguay"),
    ("concepcion_sa",   "https://www.concepcionsa.com.py/trabaja-con-nosotros",      "Concepción SA"),
    ("inpasa",          "https://www.inpasa.com.py/trabaja-con-nosotros",            "Inpasa Paraguay"),
    ("naturasol",       "https://www.naturasol.com.py/trabaja-con-nosotros",         "Naturasol"),
    ("americarne",      "https://www.americarne.com.py/trabaja-con-nosotros",        "Americarne"),
]

SOURCE = "frigorificos_py"
RUBRO  = "Frigoríficos / Industria Cárnica"
    ...
    for sel in JOB_SELECTORS:
        ...
        if items:
            for item in items:
                ...
                jobs.append(_build_job(title, org, job_url, key))
            if jobs:
                break
    ...
    if not jobs:
        for a in soup.select("a[href]"):
            ...
            if any(kw in text.lower() or kw in href.lower() for kw in LINK_KEYWORDS):
                ...
                jobs.append(_build_job(text, org, job_url, key))
...
def _build_job(title, org, job_url, key):
    return {
        "title": title,
        "organization": org,
