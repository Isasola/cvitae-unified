    ...
    <div className="w-full max-w-[400px] mx-auto p-8 flex flex-col items-center">
      ...
      <div className="relative w-24 h-24 mb-12">
        {[0, 1, 2, 3].map((i) => (
          <motion.div
            key={i}
            className="absolute w-8 h-8 bg-gradient-to-br from-gold to-[#a68a3d] rounded-sm border border-gold/50 shadow-[0_0_15px_rgba(201,168,76,0.3)]"
        ...
        {steps.map((step, index) => (
          ...
          >
            {index < currentStep ? (
              ...
              <Loader2 className="text-gold animate-spin shrink-0" size={18} />
            ) : (
