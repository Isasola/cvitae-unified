...
export function Footer() {
  ...
  return (
    <footer className="bg-background border-t border-white/5 pt-20 pb-10 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:row items-center justify-between gap-6">
          <div className="flex flex-col md:flex-row items-center gap-4 text-xs text-white/60">
            ...
            <span className="hidden md:block">•</span>
            <a href="mailto:contacto@cvitae.lat" className="text-gold hover:underline transition-colors">
              contacto@cvitae.lat
            </a>
            <span className="hidden md:block">•</span>
