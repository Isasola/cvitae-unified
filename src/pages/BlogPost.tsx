...
export default function BlogPost() {
  ...
  if (!post) return <div className="min-h-screen bg-background text-white flex items-center justify-center">Post no encontrado.</div>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-32 pb-20 px-4 max-w-4xl mx-auto">
        <div className="mb-8 flex items-center gap-4">
          <Link href="/blog" className="text-gold flex items-center gap-2 hover:underline text-sm">
            <ArrowLeft size={16} /> Volver al blog
          </Link>
          <Link href="/" className="text-muted hover:text-white text-sm">Inicio</Link>
        </div>
