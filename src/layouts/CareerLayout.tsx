...
export function CareerLayout({ children }: CareerLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-background/80 backdrop-blur-xl border-b border-white/5 z-40 px-4 flex items-center justify-between">
        <Link href="/">
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 w-64 bg-background border-r border-white/5 z-50 transform transition-transform duration-300 lg:translate-x-0',
        ...
        <div className="p-4 border-t border-white/5 space-y-1">
          ...
          <div className="mt-4 p-3 rounded-xl bg-white/[0.03] border border-white/5">
            <div className="flex items-center gap-3">
              ...
              <button onClick={handleSignOut} className="p-1.5 text-muted hover:text-red-400 transition-colors">
