...
CREATE TABLE IF NOT EXISTS public.recruiter_vacancies (
  ...
  token_id      uuid REFERENCES public.recruiter_tokens(id) ON DELETE SET NULL,
...
CREATE INDEX IF NOT EXISTS recruiter_vacancies_token_idx ON public.recruiter_vacancies(token_id);
